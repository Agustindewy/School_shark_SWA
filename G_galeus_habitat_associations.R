...
# Labeller
var_names <- as_labeller(c(Latitude = 'Latitude~S~(º)', Bathymetry = 'Bathymetry~(m)', Turbidity = 'Coefficient~Kd490~(m^-1)',
...
# Labeller
var_names <- as_labeller(c(Latitude = 'Latitude~S~(º)', Bathymetry = 'Bathymetry~(m)', Turbidity = 'Kd490~(m^-1)',
