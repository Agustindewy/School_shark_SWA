...
names(env) <- var_names
dat_summer <- read.csv('summer/G_galeus_joint.csv')
...
names(env) <- var_names
dat_autumn <- read.csv('autumn/G_galeus_joint.csv')
...
names(env) <- var_names
dat_winter <- read.csv('winter/G_galeus_joint.csv')
...
names(env) <- var_names
dat_spring <- read.csv('spring/G_galeus_joint.csv')
...
# Annual
final_mod0 <- raster('annual/Final_Model_Stats/Statistics_E/calibration_median.tif') # model
...
# Seasonal
final_mod00 <- raster('annual/Final_Model_Stats/Statistics_E/calibration_median.tif') # model
...
final_mod000 <- raster('annual/Final_Model_Stats/Statistics_E/calibration_median.tif') # model
final_mod000 <- crop(final_mod000, extent(final_mod000) + c(0.5, 0, 0, 0))
final_mod00 <- extend(final_mod000, extent(final_mod000) + 1.75)
occ_cal <- read.csv('annual/G_galeus_joint.csv') # calibration occurrences
...
# Summer
final_mod0 <- raster('summer/Final_Model_Stats/Statistics_E/calibration_median.tif') # model
final_mod0 <- crop(final_mod0, extent(final_mod0) + c(0.5, 0, 0, 0))
final_mod <- extend(final_mod0, extent(final_mod00) + 1.75)
occ_cal <- read.csv('summer/G_galeus_joint.csv') # calibration occurrences
...
# Autumn
final_mod0 <- raster('autumn/Final_Model_Stats/Statistics_E/calibration_median.tif') # model
final_mod0 <- crop(final_mod0, extent(final_mod0) + c(0.5, 0, 0, 0))
final_mod <- extend(final_mod0, extent(final_mod00) + 1.75)
occ_cal <- read.csv('autumn/G_galeus_joint.csv') # calibration occurrences
# Thresholds (%5 minimumm training presence)
mtp5 <- sdm_threshold.5(final_mod, occ_cal[, c('longitude', 'latitude')], 'p05', binary = F)
...
# Winter
final_mod0 <- raster('winter/Final_Model_Stats/Statistics_E/calibration_median.tif') # model
final_mod0 <- crop(final_mod0, extent(final_mod0) + c(0.5, 0, 0, 0))
final_mod <- extend(final_mod0, extent(final_mod00) + 1.75)
occ_cal <- read.csv('winter/G_galeus_joint.csv') # calibration occurrences
# Thresholds (%5 minimumm training presence)
mtp5 <- sdm_threshold.5(final_mod, occ_cal[, c('longitude', 'latitude')], 'p05', binary = F)
...
# Spring
final_mod0 <- raster('spring/Final_Model_Stats/Statistics_E/calibration_median.tif') # model
final_mod0 <- crop(final_mod0, extent(final_mod0) + c(0.5, 0, 0, 0))
final_mod <- extend(final_mod0, extent(final_mod00) + 1.75)
occ_cal <- read.csv('spring/G_galeus_joint.csv') # calibration occurrences
# Thresholds (%5 minimumm training presence)
mtp5 <- sdm_threshold.5(final_mod, occ_cal[, c('longitude', 'latitude')], 'p05', binary = F)
...
final_mod <- extend(final_mod0, extent(final_mod0) + 1.75)
occ_cal <- read.csv('annual/G_galeus_joint.csv') # calibration occurrences
occ_ind <- read.csv('annual/G_galeus_indep.csv') # independent occurrences
...
# Occurrences
dat <- read.csv('annual/G_galeus_joint.csv')
...
for(i in 1:4){
  ...
  final_mod0 <- raster(paste(season[i], '/Final_Model_Stats/Statistics_E/calibration_median.tif', sep = '')) # model
  final_mod0 <- crop(final_mod0, extent(final_mod0) + c(0.5, 0, 0, 0))
  final_mod <- extend(final_mod0, extent(final_mod00) + 1.75)
  occ_cal <- read.csv(paste(season[i], '/G_galeus_joint.csv', sep = '')) # calibration occurrences
...
for(i in 1:4){
  ...
  final_mod <- extend(final_mod0, extent(final_mod00) + 1.75)
  occ_cal <- read.csv(paste(season[i], '/G_galeus_joint.csv', sep = '')) # calibration occurrences
  occ_ind <- read.csv(paste(season[i], '/G_galeus_indep.csv', sep = '')) # independent occurrences
...
for(k in 1:4){
  ...
  # occurrences
  dat <- read.csv(paste(season[k], '/G_galeus_joint.csv', sep = ''))
  dat <- dat[, c('longitude', 'latitude')]
